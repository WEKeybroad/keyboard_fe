...
<div class="keyboard">
  ...
  <div class="keyboard__row common">
  ...
  <div class="keyboard__row keyboard__row--h3 common">
...
export default {
  data(){
    return {
      ...
      '~','1','2','3','4','5','6','7','8','9','0','-','=','Delete','common','Tab','Q','W','E',
      'R','T','Y','U','I','O','P','[',']','|','CapsLock','A','S','D','F','G','H','J','K','L',';',
      'shift','Z','X','C','V','B','N','M',',','.','|','Shift',,'Fn','Control','Option','null','null','null'],     
  }
  },
  props:[
    'keys'
  ...
  methods: {
    ...
    send(){
      this.getDom();
      this.returnKeys.forEach(function(keyword) {
       this.items[this.keys.IndexOf(keyword)].setAttribute('class',hilight);
       }, this);
       setTimeout(function () {
                key.removeAttribute('class',hilight);
            }, 5000); 
...
//          }
   created:function(){
     this.$parent.$on('update',this.send());
   }
   }
}
</script>
